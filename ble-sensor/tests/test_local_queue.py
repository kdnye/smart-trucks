...
class MacNormalizationTests(unittest.TestCase):
    ...
    def test_normalize_mac_hash_uses_canonicalized_input(self) -> None:
        config = ble_sensor_main.Config(
            ...
            scan_contention_summary_interval_seconds=600,
            scan_contention_adapter_reset_enabled=False,
            scan_contention_adapter_reset_interval_seconds=300,
            scan_contention_restart_after_seconds=600,
            ble_adapter="hci0",
